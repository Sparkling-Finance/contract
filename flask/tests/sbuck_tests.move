...
module flask::sbuck_tests {
    ...
    #[test, expected_failure(abort_code = flask::sbuck::ERR_INSUFFICIENT_DEPOSIT)]
    ...
    #[test, expected_failure(abort_code = flask::sbuck_tests::ENotImplemented)]
    fun test_sbuck_fail() {
